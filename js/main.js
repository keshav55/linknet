...
.controller("PostCtrl", ["$scope", "$firebaseAuth", "$location", "$firebaseObject", function($scope, $firebaseAuth, $location, $firebaseObject) {
  ...
  if(postForm.title.$error.required || postForm.startDate.$error.required || postForm.endDate.$error.required || postForm.location.$error.required || postForm.description.$error.required || postForm.startTime.$error.required || postForm.endTime.$error.required || postForm.tags.$error.required || postForm.link.$error.required || postForm.type.$error.required) {
    $scope.valid = true;
  }
